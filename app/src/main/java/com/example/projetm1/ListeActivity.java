...
import com.example.projetm1.databinding.ActivityListeBinding;
...
public class ListeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(binding.appBarListe.toolbar);
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_liste);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_settings) {
            Intent refresh = new Intent(ListeActivity.this, SettingsActivity.class);
        ...
        builder.setTitle(title)
                ...
                .setPositiveButton(title, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int id) {
                        ListeActivity.this.alertdialog.cancel();
                        SharedPreferences.Editor editor = sharedpreferences.edit();
                        editor.clear().apply();
                        //Redirect to view login
                        Toast.makeText(getApplicationContext(), message, Toast.LENGTH_SHORT).show();
                        Intent loginActivityIntent = new Intent(ListeActivity.this, MainActivity.class);
